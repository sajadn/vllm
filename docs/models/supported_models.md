...
| `NemotronLabsDiffusionModel`, `NemotronLabsDiffusionForCausalLM` | [Nemotron Labs Diffusion](nemotron_labs_diffusion.md) | `nvidia/Nemotron-Labs-Diffusion-3B`, `nvidia/Nemotron-Labs-Diffusion-8B` | | |
